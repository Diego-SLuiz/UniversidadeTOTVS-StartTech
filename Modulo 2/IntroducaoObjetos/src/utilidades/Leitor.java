...
public class Leitor {
    ...
    public static Integer lerInteiro(String mensagem, String aviso) {
        while (true) {
            try {
    ...
    public static Double lerDecimal(String mensagem, String aviso) {
        while (true) {
            try {
                return Double.parseDouble(lerTexto(mensagem));
            } catch (NumberFormatException error) {
                System.out.println(aviso);
            }
        }
