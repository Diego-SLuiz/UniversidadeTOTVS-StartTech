...
INSERT INTO curso(nome, mensalidade) VALUES('Python Básico ao Avançado', 80);
INSERT INTO curso(nome, mensalidade) VALUES('Java Avançado - Atualizado 2023', 400);
INSERT INTO curso(nome, mensalidade) VALUES('JavaScript e NodeJs', 250);
INSERT INTO curso(nome, mensalidade) VALUES('SpringBoot na Prática', 180);
INSERT INTO curso(nome, mensalidade) VALUES('Linguagem C', 300);

INSERT INTO modulo(nome) VALUES ('Lógica de Programção');
...
INSERT INTO endereco(cidade, rua, numero) VALUES('Aparecida de Goiânia', 'Rua Bauru', 12);
INSERT INTO endereco(cidade, rua, numero) VALUES('Belém', 'Quadra N', 55);
INSERT INTO endereco(cidade, rua, numero) VALUES('Rondonópolis', 'Rua Gv-30', 26);
INSERT INTO endereco(cidade, rua, numero) VALUES('Altamira', 'Avenida João Rodrigues', 37);
...
INSERT INTO endereco(cidade, rua, numero) VALUES('Brasília', 'Quadra QNR 4', 9);
INSERT INTO endereco(cidade, rua, numero) VALUES('Vitória', 'Rua Gonçalves Dias', 81);
...
INSERT INTO endereco(cidade, rua, numero, complemento) VALUES('Ribeirão das Neves', 'Rua Bálsamo', 49, 'Casa 4');
INSERT INTO endereco(cidade, rua, numero, complemento) VALUES('Corumbá', 'Alameda Idalécio Proença', 34, 'Casa 5');
INSERT INTO endereco(cidade, rua, numero, complemento) VALUES('Ji-Paraná', 'Rua Boa Vista', 61, 'Bloco A');
INSERT INTO endereco(cidade, rua, numero, complemento) VALUES('Olinda', 'Rua do Reflexo', 78, 'Bloco B');
INSERT INTO endereco(cidade, rua, numero, complemento) VALUES('Brasília', 'Praça dos Três Poderes Anexo II', 31, 'Bloco C');
INSERT INTO endereco(cidade, rua, numero, complemento) VALUES('Fortaleza', 'Rua 610', 40, 'Bloco D');
INSERT INTO endereco(cidade, rua, numero, complemento) VALUES('João Pessoa', 'Vila Marcos Barbosa', 33, 'Bloco E');
...
INSERT INTO aluno(id_endereco, nome, cpf, email, data_nascimento) VALUES(2, 'Heitor Sérgio Bryan Novaes', '55137936103', 'heitorsergionovaes@ipek.net.br', '25/01/1951');
...
INSERT INTO aluno(id_endereco, nome, cpf, email, data_nascimento) VALUES(5, 'Gael Danilo Mário da Rosa', '56459619352', 'gaeldanilodarosa@integrasjc.com.br', '19/01/1961');
INSERT INTO aluno(id_endereco, nome, cpf, email, data_nascimento) VALUES(6, 'Luís Anderson Anderson Drumond', '46142468261', 'luis_drumond@sunrise.com.br', '02/01/1977');
INSERT INTO aluno(id_endereco, nome, cpf, email, data_nascimento) VALUES(7, 'Francisca Cláudia Lorena da Silva', '52756612901', 'francisca_claudia_dasilva@duoarq.com', '14/01/1998');
...
INSERT INTO aluno(id_endereco, nome, cpf, email, data_nascimento) VALUES(9, 'Stella Cláudia Laura Drumond', '47333058344', 'stella_drumond@lojapetline.com.br', '03/01/1960');
...
INSERT INTO aluno(id_endereco, nome, cpf, email, data_nascimento) VALUES(11, 'Calebe José Caleb Rodrigues', '96904984791', 'calebe_jose_rodrigues@ficopola.net', '22/01/1982');
...
INSERT INTO aluno(id_endereco, nome, cpf, email, data_nascimento) VALUES(18, 'Jéssica Camila Oliveira', '29299168180', 'jessica_oliveira@consultorialk.com.br', '15/01/1982');
